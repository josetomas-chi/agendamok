...
import { Loader2, Calendar, Clock, Users, DollarSign, MapPin, ChevronRight, Check } from "lucide-react"
...
export default function SchoolGroupPage() {
  const { businessSlug, groupSlug } = useParams<{ businessSlug: string; groupSlug: string }>()
