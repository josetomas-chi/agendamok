...
type Participant = { id: string; name: string; phone: string | null; players: { name: string; phone?: string }[]; seed: number | null; status: string; group: string | null; categoryId: string | null; restrictions?: { date: string; time: string }[] }
type Match = {
