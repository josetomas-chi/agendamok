...
type Membership = {
  ...
  client: { id: string; name: string; lastName?: string | null; email: string | null }
...
export default function MembershipsClient({
  ...
  const { businessId: ctxBid } = useBusiness()
  const businessId = ctxBid || initialBusinessId
  ...
  // No initial useEffect — data is pre-loaded from server via props
