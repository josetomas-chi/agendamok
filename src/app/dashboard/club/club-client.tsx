  ...
  return (
    <div className="rounded-2xl overflow-hidden" style={{ border: BORDER, background: "#ffffff", boxShadow: "0 1px 8px rgba(0,0,0,0.06)" }}>
      {courts.length === 0 ? (
        ...
        <div className="overflow-auto max-h-[calc(100vh-160px)] md:max-h-[calc(100vh-180px)] [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]" ref={gridRef}>
                  ...
                  {slots.map((slot) => {
                    ...
                    return (
                      <div key={slot}
                        ...
                        style={{
                          height: SLOT_HEIGHT,
                          borderBottom: slot.endsWith(":00") ? `1px solid rgba(13,27,42,0.06)` : `2px solid rgba(13,27,42,0.35)`,
                    ...
                    return (
                      <div key={b.id}
                        ...
                        style={{ top, height,
                          ...
                          boxShadow: isBlockEntry ? `inset 0 0 0 5px #aaa` : `inset 0 0 0 5px ${(b.status === "COMPLETED" || (Number(b.price) > 0 && Number(b.paidAmount) >= Number(b.price))) ? "#16a34a" : b.coach?.color ?? "#C9A84C"}`,
